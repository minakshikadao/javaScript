...
console.log(`===== Remove an very first element =====`);
let arrayNumbers = [11, 22, 33, 44, 55]
arrayNumbers.shift();
console.log(arrayNumbers);

console.log(`===== Remove an very last element =====`);
arrayNumbers.pop();
console.log(arrayNumbers);
...
console.log(`===== Selecting multiple element =====`);
...
console.log(`===== Insert an elements at the middle  =====`);
let arrayN = [11, 22, 33, 44, 55, 66, 77];
 arrayN.splice(3, 0, 99)
 console.log(arrayN);


 console.log(`===== Replacing an elements at the middle  =====`);
